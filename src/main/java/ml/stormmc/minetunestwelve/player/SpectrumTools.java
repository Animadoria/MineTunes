...
public final class SpectrumTools {
    ...
    public static float[] getFFTCalculation() {
        if(MineTunesTwelve.musicPlayerThread == null || MineTunesTwelve.musicPlayerThread.player == null)
            throw new RuntimeException("No player!");

        Decoder decoder = MineTunesTwelve.musicPlayerThread.player.getDecoder();
