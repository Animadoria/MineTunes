...
public class GuiPlaylistManager extends GuiMineTunes {
    ...
    public void initGui() {
        ...
        buttonList.add(showHudButton = new GuiButton(2, 225, 5, 90, 20, I18n.format("minetunes.gui.showHud_true")));
        buttonList.add(moveHudButton = new GuiButton(3, 325, 5, 70, 20, I18n.format("minetunes.gui.move")));
        buttonList.add(playModeButton = new GuiButton(4, 225, 30, 170, 20, I18n.format("minetunes.gui.playMode0")));
    ...
    public void drawScreen(int mx, int my, float partialTicks) {
        ...
        boolean creatingPlaylist = MineTunesTwelve.playlistCreatorThread != null;
        if(creatingPlaylist) {
            String creating = TextFormatting.DARK_AQUA + I18n.format("minetunes.gui.creatingPlaylist");
            String status = MineTunesTwelve.playlistCreatorThread.getProgressState();
        ...
        showHudButton.displayString = I18n.format("minetunes.gui.showHud_" + MTTConfig.hudEnabled);
        moveHudButton.enabled = MTTConfig.hudEnabled;
        playModeButton.displayString = I18n.format("minetunes.gui.playMode" + MTTConfig.playMode);
    ...
    protected void keyTyped(char c, int i) throws IOException {
        if(MineTunesTwelve.playlistCreatorThread == null)
    ...
    protected void actionPerformed(GuiButton button) {
        ...
        switch(button.id) {
            ...
            case 1:
                ...
                break;
            case 2:
                MTTConfig.hudEnabled = !MTTConfig.hudEnabled;
                configChanged = true;
                break;
            case 3:
                ...
                break;
            case 4:
                MTTConfig.playMode = MTTConfig.playMode == 3 ? 0 : MTTConfig.playMode + 1;
                configChanged = true;
                break;
            case 5:
                ...
                break;
            case 6:
                if(currentPlaylist == selectedPlaylist && MineTunesTwelve.musicPlayerThread != null)
                    MineTunesTwelve.musicPlayerThread.resetPlayer();
    ...
    public static void selectCurrentPlaylist(int playlist, int song) {
        ...
        if(MineTunesTwelve.musicPlayerThread != null)
            MineTunesTwelve.musicPlayerThread.onPlaylistChange();
    }
